...
const aboutformName = document.querySelector('.popup__form-info_type_name');
const aboutformProfession = document.querySelector('.popup__form-info_type_profession');
